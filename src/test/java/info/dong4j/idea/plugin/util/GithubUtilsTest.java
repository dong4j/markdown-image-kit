...
public class GithubUtilsTest {
    ...
    /** 资源文件路径，指向图片文件 mik.jpg */
    private static final String path = "/mik.jpg";
     ...
     * 预期结果：应返回操作是否成功的布尔值
     * <p>
     * 说明：该测试需要本地存在指定路径的文件（如 ~/Downloads/mik.jpg），并确保 GitHub API 地址和认证 token 正确配置
     */
    @Test
    public void test() throws Exception {
        String url = GITHUB_API + "/repos/" + owner + "/" + repos + "/contents" + path;
        File file = new File("~/Downloads/mik.jpg");
