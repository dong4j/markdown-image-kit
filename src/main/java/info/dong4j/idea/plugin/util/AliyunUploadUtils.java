...
//     }
//
//     // todo-dong4j : (2019年03月18日 08:29) [没有配置时初始化错误]
...
//         accessKeySecret = DES.decrypt(accessKeySecret, OssState.ALIYUN);
...
//      * @return the string
//      */
//     private static void uploadFile2OSS(InputStream instream, String filedir, String fileName) {
...
//      * @return the string
//      */
//     private static void uploadFile2OSS(OSS ossClient,
