 ...
 */
class UploadResultNotification extends Notification {
  ...
  private static final Logger LOG = Logger.getInstance(UploadResultNotification.class);

  UploadResultNotification(@NotNull String groupDisplayId,
  ...
  @NotNull
  static UploadResultNotification create(@NotNull Project project, @NotNull GitPushResult pushResult, boolean multiRepoProject) {
    ...
    UploadResultNotification notification = new UploadResultNotification(group.getDisplayId(), title, description, type);
