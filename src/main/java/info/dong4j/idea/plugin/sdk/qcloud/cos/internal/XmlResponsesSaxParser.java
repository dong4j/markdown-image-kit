...
import info.dong4j.idea.plugin.sdk.qcloud.cos.exception.MultiObjectDeleteException.DeleteError;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.AbortIncompleteMultipartUpload;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketLifecycleConfiguration.NoncurrentVersionTransition;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketLifecycleConfiguration.Rule;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketLifecycleConfiguration.Transition;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.CORSRule;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.CORSRule.AllowedMethods;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.COSObjectSummary;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.COSVersionSummary;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GroupGrantee;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.InitiateMultipartUploadResult;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.MultipartUpload;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Owner;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.PartListing;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.PartSummary;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Permission;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ReplicationDestinationConfig;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ReplicationRule;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Tag.LifecycleTagPredicate;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Tag.Tag;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.UinGrantee;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.VersionListing;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.lifecycle.LifecycleAndOperator;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.lifecycle.LifecycleFilter;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.lifecycle.LifecycleFilterPredicate;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.lifecycle.LifecyclePrefixPredicate;
