...
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.COSDirectSpi;
...
public interface COS extends COSDirectSpi {
     ...
     */
    COSObject getObject(String bucketName, String key)
            throws CosClientException, CosServiceException;
     ...
     * @throws CosServiceException If any errors occurred in while processing the request.
     */
    Bucket createBucket(String bucketName) throws CosClientException, CosServiceException;
     ...
     *
     */
    void deleteBucket(String bucketName) throws CosClientException, CosServiceException;
     ...
     */
    VersionListing listVersions(String bucketName, String prefix, String keyMarker,
     ...
     *
     */
    BucketVersioningConfiguration getBucketVersioningConfiguration(
     ...
     * @throws CosServiceException If any errors occurred in COS while processing the request.
     */
    void setBucketCrossOriginConfiguration(
     ...
     */
    void deleteBucketCrossOriginConfiguration(
     ...
     * @throws CosServiceException If any errors occurred in COS while processing the request.
     */
    BucketReplicationConfiguration getBucketReplicationConfiguration(String bucketName)
            throws CosClientException, CosServiceException;
     ...
     * @throws CosServiceException If any errors occurred in COS while processing the request.
     */
    void updateObjectMetaData(String bucketName, String key, ObjectMetadata objectMetadata)
            throws CosClientException, CosServiceException;
