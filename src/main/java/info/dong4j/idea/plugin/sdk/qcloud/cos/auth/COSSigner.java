...
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.LINE_SEPARATOR;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_AK;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_HEADER_LIST;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_KEY_TIME;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_SIGNATURE;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_SIGN_ALGORITHM_KEY;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_SIGN_ALGORITHM_VALUE;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_SIGN_TIME;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSignerConstants.Q_URL_PARAM_LIST;
