...
import info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSessionCredentials;
import info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSSigner;
import info.dong4j.idea.plugin.sdk.qcloud.cos.auth.COSStaticCredentialsProvider;
import info.dong4j.idea.plugin.sdk.qcloud.cos.endpoint.EndpointBuilder;
import info.dong4j.idea.plugin.sdk.qcloud.cos.endpoint.RegionEndpointBuilder;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.exception.CosServiceException.ErrorType;
import info.dong4j.idea.plugin.sdk.qcloud.cos.exception.MultiObjectDeleteException;
import info.dong4j.idea.plugin.sdk.qcloud.cos.exception.Throwables;
import info.dong4j.idea.plugin.sdk.qcloud.cos.http.CosHttpClient;
import info.dong4j.idea.plugin.sdk.qcloud.cos.http.CosHttpRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.http.DefaultCosHttpClient;
import info.dong4j.idea.plugin.sdk.qcloud.cos.http.HttpMethodName;
import info.dong4j.idea.plugin.sdk.qcloud.cos.http.HttpResponseHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.BucketNameUtils;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.COSObjectResponseHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.COSStringResponseHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.COSVersionHeaderHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.COSXmlResponseHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.Constants;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.CosMetadataResponseHandler;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.DeleteObjectsResponse;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.DigestValidationInputStream;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.InputSubstream;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.LengthCheckInputStream;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.MD5DigestCalculatingInputStream;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.MultiObjectDeleteXmlFactory;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.ObjectExpirationHeaderHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.ReleasableInputStream;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.RequestXmlFactory;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.ResettableInputStream;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.ResponseHeaderHandlerChain;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.ServerSideEncryptionHeaderHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.ServiceClientHolderInputStream;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.SkipMd5CheckStrategy;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.Unmarshaller;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.Unmarshallers;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.VIDResultHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.VoidCosResponseHandler;
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.XmlResponsesSaxParser.CompleteMultipartUploadHandler;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.AccessControlList;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.AclXmlFactory;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Bucket;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketConfigurationXmlFactory;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketCrossOriginConfiguration;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketLifecycleConfiguration;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketPolicy;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketReplicationConfiguration;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.BucketVersioningConfiguration;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.CannedAccessControlList;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.CopyObjectResult;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.CosDataSource;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.CreateBucketRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.DeleteBucketCrossOriginConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.DeleteBucketLifecycleConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.DeleteBucketPolicyRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.DeleteBucketReplicationConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.DeleteBucketRequest;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.DeleteObjectsResult;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.DeleteVersionRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GeneratePresignedUrlRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GenericBucketRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetBucketAclRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetBucketCrossOriginConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetBucketLifecycleConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetBucketLocationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetBucketPolicyRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetBucketReplicationConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetBucketVersioningConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetObjectAclRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetObjectMetadataRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.GetObjectRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Grant;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Grantee;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.HeadBucketRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.HeadBucketResult;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.HeadBucketResultHandler;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ListBucketsRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ListMultipartUploadsRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ListNextBatchOfObjectsRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ListNextBatchOfVersionsRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ListObjectsRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ListPartsRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ListVersionsRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.MultipartUploadListing;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.PartListing;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.Permission;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.ResponseHeaderOverrides;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.RestoreObjectRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SSECOSKeyManagementParams;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SSECustomerKey;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SetBucketAclRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SetBucketCrossOriginConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SetBucketLifecycleConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SetBucketPolicyRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SetBucketReplicationConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SetBucketVersioningConfigurationRequest;
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.SetObjectAclRequest;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.model.VersionListing;
import info.dong4j.idea.plugin.sdk.qcloud.cos.region.Region;
import info.dong4j.idea.plugin.sdk.qcloud.cos.utils.Base64;
import info.dong4j.idea.plugin.sdk.qcloud.cos.utils.BinaryUtils;
import info.dong4j.idea.plugin.sdk.qcloud.cos.utils.DateUtils;
import info.dong4j.idea.plugin.sdk.qcloud.cos.utils.Md5Utils;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.utils.UrlEncoderUtils;
...
import static info.dong4j.idea.plugin.sdk.qcloud.cos.internal.LengthCheckInputStream.EXCLUDE_SKIPPED_BYTES;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.internal.LengthCheckInputStream.INCLUDE_SKIPPED_BYTES;
...
public class COSClient implements COS {
    ...
    public PutObjectResult putObject(String bucketName, String key, InputStream input,
            ObjectMetadata metadata) throws CosClientException {
