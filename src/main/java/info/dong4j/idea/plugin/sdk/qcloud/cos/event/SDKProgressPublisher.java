...
import static info.dong4j.idea.plugin.sdk.qcloud.cos.event.ProgressEventType.HTTP_REQUEST_CONTENT_RESET_EVENT;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.event.ProgressEventType.HTTP_RESPONSE_CONTENT_RESET_EVENT;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.event.ProgressEventType.REQUEST_BYTE_TRANSFER_EVENT;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.event.ProgressEventType.REQUEST_CONTENT_LENGTH_EVENT;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.event.ProgressEventType.RESPONSE_BYTE_TRANSFER_EVENT;
import static info.dong4j.idea.plugin.sdk.qcloud.cos.event.ProgressEventType.RESPONSE_CONTENT_LENGTH_EVENT;
