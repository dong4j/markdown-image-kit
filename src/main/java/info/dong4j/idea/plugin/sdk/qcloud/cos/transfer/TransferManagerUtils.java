...
import static info.dong4j.idea.plugin.sdk.qcloud.cos.internal.Constants.MAXIMUM_UPLOAD_PARTS;
...
public class TransferManagerUtils {
    ...
    public static long calculateOptimalPartSize(PutObjectRequest putObjectRequest, TransferManagerConfiguration configuration) {
        ...
        double optimalPartSize = contentLength / (double)MAXIMUM_UPLOAD_PARTS;
