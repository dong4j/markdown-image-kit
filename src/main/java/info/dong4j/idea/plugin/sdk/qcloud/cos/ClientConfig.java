...
import info.dong4j.idea.plugin.sdk.qcloud.cos.endpoint.DefaultEndpointResolver;
import info.dong4j.idea.plugin.sdk.qcloud.cos.endpoint.EndpointBuilder;
import info.dong4j.idea.plugin.sdk.qcloud.cos.endpoint.EndpointResolver;
import info.dong4j.idea.plugin.sdk.qcloud.cos.endpoint.RegionEndpointBuilder;
import info.dong4j.idea.plugin.sdk.qcloud.cos.endpoint.SuffixEndpointBuilder;
import info.dong4j.idea.plugin.sdk.qcloud.cos.http.HttpProtocol;
