...
import info.dong4j.idea.plugin.sdk.qcloud.cos.event.ProgressInputStream;
...
import info.dong4j.idea.plugin.sdk.qcloud.cos.internal.SdkBufferedInputStream;
...
public class DefaultCosHttpClient implements CosHttpClient {
    ...
    private <X extends CosServiceRequest> CosServiceException handlerErrorMessage(
        ...
        try {
            ...
            exception = new CosServiceException("Upload error");
